...
import javax.swing.JInternalFrame ;
public class jtDistributor1  extends JFrame implements ActionListener
{
	String h[]={"Distributor Id","Distributor Name","Distributor Address","Contact No"};
	int cnt=0,i=0;
	JLabel l1,l,z,z1;
	JScrollPane jpane;
	JTable t1;
	...
	public  jtDistributor1()
	{
		...
		try
		{
			...
			String str="select * from Distributor1";
			...
			String s="select * from Distributor1";
			...
			t2.setText(d.format(date));
           			...
           			l1=new JLabel("Distributor Details");
	...
	{
		jtDistributor1 cr=new jtDistributor1();
	}
}
