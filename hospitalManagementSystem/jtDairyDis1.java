...
import javax.swing.JInternalFrame ;
public class jtDairyDis1  extends JFrame implements ActionListener
{
	String h[]={"Dairy Distribution Id","Distribution Date","Distributor Id","Distributor name","Total Milk","Milk Type","Milk Rate","Total Amount"};
	int cnt=0,i=0;
	JLabel l1,l,z,z1;
	JScrollPane jpane;
	JTable t1;
	...
	public  jtDairyDis1()
	{
		...
		try
		{
			...
			String str="select * from DairyDis";
			...
			t2.setText(d.format(date));
           			...
           			l1=new JLabel("Dairy Distribution Details");
	...
	{
		jtDairyDis1 cr=new jtDairyDis1();
	}
}
