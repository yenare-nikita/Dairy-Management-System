...
import javax.swing.JInternalFrame ;
public class jtMilk1 extends JFrame implements ActionListener
{
	String h[]={"Milk Type","fat","snf","Protein","Milk Rate"};
	int cnt=0,i=0;
	JLabel l1,l,z,z1;
	JScrollPane jpane;
	JTable t1;
	...
	public  jtMilk1()
	{
		...
		try
		{
			...
			while(rs.next())
			{
				...
				record1[i][1]=Integer.toString(rs.getInt(2));
