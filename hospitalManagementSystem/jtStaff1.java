...
import javax.swing.JInternalFrame ;
public class jtStaff1  extends JFrame implements ActionListener
{
	String h[]={"Staff Id","Staff Name","Staff Address","Contact No","Staff Department"};
	int cnt=0,i=0;
	JLabel l1,l,z,z1;
	JScrollPane jpane;
	JTable t1;
