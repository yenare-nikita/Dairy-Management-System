...
import javax.swing.JInternalFrame ;
public class jtMilkCollection1  extends JFrame implements ActionListener
{
	String h[]={"MilkCollection Id","MilkCollection Date","Society Id","Society name","Milk Type1","Total Milk","Fat","SNF","Milk Rate2","Milk Type2","Total Milk","Fat","SNF","Milk Rate2"};
	int cnt=0,i=0;
	JLabel l1,l,z,z1;
	JScrollPane jpane;
	JTable t1;
	...
	public  jtMilkCollection1()
	{
		...
		try
		{
			...
			String str="select * from MilkCollection1";
			...
			rs.close(); 
			String record1[][]=new String[cnt][14];
                                                          Statement st1=c.createStatement();
			String s="select * from MilkCollection1";
			...
			while(rs.next())
			{
				...
				record1[i][2]=Integer.toString(rs.getInt(3));
				record1[i][3]=rs.getString(4);
				//record1[i][4]=Integer.toString(rs.getInt(5));
			                  record1[i][4]=rs.getString(5);
				record1[i][5]=Integer.toString(rs.getInt(6));
				record1[i][6]=Integer.toString(rs.getInt(7));
				record1[i][7]=Integer.toString(rs.getInt(8));
				record1[i][8]=Integer.toString(rs.getInt(9));
				record1[i][9]=rs.getString(10);
				record1[i][10]=Integer.toString(rs.getInt(11));
				record1[i][11]=Integer.toString(rs.getInt(12));
				record1[i][12]=Integer.toString(rs.getInt(13));
				record1[i][13]=Integer.toString(rs.getInt(14));
			...
			t2.setText(d.format(date));
           			...
           			l1=new JLabel("MilkCollection Details");
	...
	{
		jtMilkCollection1 cr=new jtMilkCollection1();
	}
}
