...
import javax.swing.JInternalFrame ;
public class jtDairyBills1  extends JFrame implements ActionListener
{
	String h[]={"Bill Id","Bill Date","Milk Collection Id","Milk Collection Date","Society name","Milk Type"," Milk Quantity","Fat","SNF","Milk Rate","Total Amount"};
	int cnt=0,i=0;
	JLabel l1,l,z,z1;
	JScrollPane jpane;
	JTable t1;
	...
	public  jtDairyBills1()
	{
		...
		try
		{
			...
			String str="select * from DairyBills1";
			...
			String s="select * from DairyBills1";
			...
			while(rs.next())
			{
				...
				record1[i][8]=Integer.toString(rs.getInt(9));
			                  record1[i][9]=Integer.toString(rs.getInt(10));
			...
			t2.setText(d.format(date));
           			...
           			l1=new JLabel("Dairy Bill Details");
	...
	{
		jtDairyBills1 cr=new jtDairyBills1();
	}
}
